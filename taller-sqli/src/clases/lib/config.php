...
global $KEY_PATH;
global $CUIT_NEGOCIO;
global $URL_SERVER_FACTURA_ELECTRONICA;
...
$EMAIL = "socios@semacor.org.ar";
$PASSWORD_EMAIL = "t0J)DvScAv~R";
$SMTP_HOST = "mail.semacor.org.ar";

$PROTOCOL = 'http://';
$SERVER_PATH = dirname(__FILE__) . '/';
$HTTP_HOST = (isset($_SERVER['HTTP_HOST'])) ? $_SERVER['HTTP_HOST'] . '/' : '/';
$WEB_PATH = $PROTOCOL . $HTTP_HOST . $PROJECT_REL_PATH;
$PAGINA_WEB_PATH = $PROTOCOL . $HTTP_HOST . 'wp/';

$LOGIN_PATH = $WEB_PATH;
$PUBLIC_PATH = $SERVER_PATH . "public/";
$PERFIL_PATH = $WEB_PATH . $CTRL_REL_PATH . 'perfil.ctrl.php';
$UPLOAD_PATH = $SERVER_PATH . 'res/img/articulos/';

$KEY_PATH = $SERVER_PATH . 'res/seguridad/';
...
global $PACKAGES;
$PACKAGES = array('bd', 'data', 'datos', 'sesion', 'lib');
...
$DB_HOST = 'semacor.org.ar';
$DB_USER = 'semacor_gestion';
$DB_PASS = 'Xf,!9e$cd@@o';
$DB_NAME = 'semacor_semacor';




PoolConnectionDb::get_instance()->add_connection_db(new MySqlConnectionDb($DB_HOST, $DB_USER, $DB_PASS, $DB_NAME), 'taller_sqli');
session_name("taller_sqli");
session_start();
